...
app.config['MYSQL_DATABASE_PASSWORD'] = 'Zabda@2021jaya'
app.config['MYSQL_DATABASE_DB'] = 'jayadb'
...
def init_jayadb():
    drop_table = 'DROP TABLE IF EXISTS jayadb.books;'
    books_table = """
    CREATE TABLE jayadb.books(
    ...
    """
    data = """
    INSERT INTO jayadb.books (title, author, is_sold)
    VALUES
...
def home():
    ...
    # </head>
    # <body> 
    # <h1>Welcome to the jayaas's Bookstore API Service </h1>
    # <img src="https://www.shutterstock.com/shutterstock/photos/415603990/display_1500/stock-vector-well-done-paper-banner-with-color-confetti-vector-illustration-415603990.jpg" alt="WELLDONE IMAGE"></body>
    # </html>"""
